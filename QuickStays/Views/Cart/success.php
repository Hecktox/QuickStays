...
<body>
    ...
    <div class="container mt-5">
        ...
        <p class="text-center">Thank you for choosing QuickStays!</p>
        <a href="/eCommerce-Project/QuickStays/index.php?entity=cart&action=history"
            class="btn btn-primary btn-block">View Booking History</a>
