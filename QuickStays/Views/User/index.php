            ...
            <div class="col-12">
                <div class="cta-section d-flex align-items-center justify-content-center"
                    ...
                    <div class="text-center text-white" style="background: rgba(0, 0, 0, 0.5); padding: 20px;">
                        ...
                        <p class="my-3">Earn money by renting out your vacation home, unused apartment, or extra room.
                        </p>
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-text">"Amazing experience from start to finish. The booking process was easy
                                and
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-text">"We loved the location and the amenities provided. It felt like a home
                                away
